...
const message = ref('MESSAGE TEST')
    ...
    <div class="max-w-2xl mx-auto py-8">
        ...
        <div class="mb-6 flex items-center space-x-2">
            <div class="flex items-center">
                ...
                <span class="text-sm text-gray-900"> {{ (!socket.connected) ? 'Not' : '' }} Connected</span>
            </div>
        </div>
        ...
        <form class="space-y-6">
            <div class="space-y-2">
                ...
                <div class="flex space-x-4">
                    <input type="text" id="message" v-model="message"
                        class="flex-1 px-3 py-2 bg-white border border-gray-900 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            ...
            <div v-if="responseData" class="space-y-2 mt-8">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-xs text-black-900">Real-time updates</span>
                </div>
